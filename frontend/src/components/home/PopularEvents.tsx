    ...
    return (
        <section className="py-6 bg-stone-900">
            ...
            <div className="relative group">
                ...
                <button
                    onClick={() => scroll('left')}
                    className="hidden md:flex absolute left-0 top-1/2 -translate-y-1/2 z-20 bg-white/90 text-stone-900 p-2 rounded-full shadow-lg hover:bg-white hover:scale-110 transition-all ml-2 opacity-0 group-hover:opacity-100 focus:opacity-100"
                ...
                <button
                    ...
                    className="hidden md:flex absolute right-0 top-1/2 -translate-y-1/2 z-20 bg-white/90 text-stone-900 p-2 rounded-full shadow-lg hover:bg-white hover:scale-110 transition-all mr-2 opacity-0 group-hover:opacity-100 focus:opacity-100"
                        ...
                        >
                            ...
                            <div className="relative aspect-[2/3] rounded-xl md:rounded-none overflow-hidden bg-stone-800 shadow-2xl border border-white/5 group-hover/card:border-white/20 transition-all duration-500">
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-6 pt-12 bg-gradient-to-t from-black to-transparent">
                                    <p className="text-white font-bold text-lg line-clamp-2 leading-tight group-hover/card:text-amber-400 transition-colors duration-300">
                                        {event.title}
                                    </p>
