...
interface SpotlightEventsProps {
    events: EventResponse[];
    isLoading: boolean;
}

export default function SpotlightEvents({ events, isLoading }: SpotlightEventsProps) {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-6 flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                        Featured events happening soon across the Highlands
                    </p>
                </div>
            </div>
