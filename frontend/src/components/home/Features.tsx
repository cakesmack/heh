            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
                    ...
                    <div className="flex flex-col items-center text-center max-w-sm mx-auto">
                        ...
                        <h3 className="text-2xl font-bold text-gray-900 mb-3">The One Source</h3>
                    ...
                    <div className="flex flex-col items-center text-center max-w-sm mx-auto">
                        ...
                        <h3 className="text-2xl font-bold text-gray-900 mb-3">Real Events Only</h3>
                    ...
                    <div className="flex flex-col items-center text-center max-w-sm mx-auto">
                        ...
                        <h3 className="text-2xl font-bold text-gray-900 mb-3">Built for Locals</h3>
