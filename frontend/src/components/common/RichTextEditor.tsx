    ...
    return (
        <div className="space-y-1">
            <div className={`
                ...
                ${error ? 'border-red-500 ring-1 ring-red-500' : 'border-gray-300 focus-within:ring-2 focus-within:ring-emerald-500 focus-within:border-emerald-500'}
                ${className}
            `}>
                {/* Toolbar */}
                <div className={`flex items-center gap-1 p-2 border-b transition-colors ${error ? 'bg-red-50 border-red-200' : 'bg-gray-50 border-gray-200'}`}>
                    <button
                        type="button"
                ...
                <div className="bg-white relative">
                    ...
                    {!value && (
                        <div className="absolute top-[10px] left-3 text-gray-400 pointer-events-none">
                            {placeholder}
                        </div>
                    )}
                </div>
            ...
            <div className="flex justify-between items-center px-1">
                ...
                <p className={`text-xs ${isOverLimit ? 'text-red-600 font-bold' : 'text-gray-400'}`}>
