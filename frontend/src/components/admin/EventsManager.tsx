...
export default function EventsManager() {
  ...
  const [promoteSlotType, setPromoteSlotType] = useState<'category_pinned' | 'magazine_carousel' | 'premium'>('premium');
  ...
  const getStatusBadge = (status?: string | null) => {
    if (!status) return <span className="px-2 py-0.5 text-xs rounded-full bg-gray-100 text-gray-600">â€”</span>;
                    ...
                    <td className="py-3 px-4">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <span className="text-xs text-gray-500">{event.venue_name || event.location_name || 'â€”'}</span>
                        </div>
                      </div>
                    </td>
                    <td className="py-3 px-4 text-sm text-gray-600">
                      {event.organizer_username || (event.organizer_email ? event.organizer_email.split('@')[0] : 'â€”')}
                    </td>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-emerald-500"
                  placeholder="e.g., Free, Â£5, Â£5-Â£10"
                />
              </div>
        ...
        >
          <div className="space-y-4">
            <p className="text-sm text-gray-600">
              Promote this event as a Premium Placement. This will pin the event to the top of standard search results, homepage lists, and directories.
            </p>
            <p className="text-sm text-gray-600">
              The promotion will run until the event ends or you manually stop it.
            </p>
