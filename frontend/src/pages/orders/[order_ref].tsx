            ...
            >
              ...
              <div className="p-6 md:p-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                  ...
                  <div className="flex flex-col items-center justify-center p-4 bg-stone-50 rounded-xl border border-stone-200 text-center print:bg-white">
                    <div className="p-2.5 bg-white border border-stone-200 rounded-xl shadow-xs inline-block">
