  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const eventData = {
        ...
        venue_id: (locationTab === 'main' && locationMode === 'venue') ? (formData.venue_id || undefined) : undefined,
        location_name: (locationTab === 'main' && locationMode === 'custom') ? formData.location_name : undefined,
        latitude: (locationTab === 'main' && locationMode === 'custom') ? formData.latitude : undefined,
        longitude: (locationTab === 'main' && locationMode === 'custom') ? formData.longitude : undefined,
